 ...
 *
 */
public class OptimumLoadBalancer extends VmLoadBalancer implements CloudSimEventListener {
	...
	public OptimumLoadBalancer(DatacenterController dcb){
