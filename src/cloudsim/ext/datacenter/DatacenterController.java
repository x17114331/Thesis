...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		if (loadBalancePolicy.equals(Constants.LOAD_BALANCE_ACTIVE)){
			this.loadBalancer = new LeastConnectionLoadBalancer(this);
			...
			//this.loadBalancer = new GPLBMS(vmStatesList);
                        this.loadBalancer = new ExtendedLoadBalancer(this);
		}
	...
	private void submitNewCloudlet(InternetCloudlet cl) {
		...
		if (nextAvailVM == -1){
			...
			queuedCount++;
                         ...
                         String ct = cl.getCloudletId() + "#" + nextAvailVM;
                         FileAppender.AppendtoFile("vmallocateresults.txt",ct);
