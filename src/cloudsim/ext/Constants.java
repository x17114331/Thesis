...
public interface Constants {
	...
	final String LOAD_BALANCE_POLICY_RR = "Round Robin Load Balancer";
	final String LOAD_BALANCE_ACTIVE = "Least Connection Balancer";
	final String LOAD_BALANCE_THROTTLED = "Reliable Maximum Utility Balancer";
}
